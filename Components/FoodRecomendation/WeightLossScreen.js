...
const WeightLossScreen = ({navigation}) => {
  ...
  //     if(resultLoss){
  //       navigation.navigate("ResultWeightLoss",{ResultLoss: resultLoss })
  //     }
  ...
  return (
    ...
    <View style={styles.MinCont}>
      ...
      <TouchableOpacity style={styles.touchableOpacity} onPress={()=>navigation.navigate("ResultWeightLoss",{age,weight,height})}>
